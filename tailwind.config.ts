  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        surface: {
          dark:    '#0B1F3A', // primary dark bg
          darker:  '#060F1E', // deepest bg
          mid:     '#122F55', // mid-dark section
          light:   '#F8FAFC', // light section
          cream:   '#FEFDF8', // warm light section
        },
      },
      ...
      backgroundImage: {
        'gradient-hero':     'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(245,158,11,0.15) 0%, transparent 60%), radial-gradient(ellipse 60% 40% at 80% 50%, rgba(30,65,117,0.3) 0%, transparent 60%), linear-gradient(180deg, #060F1E 0%, #0B1F3A 50%, #060F1E 100%)',
        'gradient-section':  'linear-gradient(180deg, #0B1F3A 0%, #060F1E 100%)',
        'gradient-light':    'linear-gradient(180deg, #F8FAFC 0%, #FEFDF8 100%)',
        'gradient-gold':     'linear-gradient(135deg, #F59E0B 0%, #FBBF24 100%)',
        'gradient-gold-dark':'linear-gradient(135deg, #D97706 0%, #F59E0B 100%)',
        'gradient-cta':      'radial-gradient(ellipse 70% 50% at 50% 100%, rgba(245,158,11,0.18) 0%, transparent 70%), linear-gradient(180deg, #060F1E 0%, #040D1A 100%)',
