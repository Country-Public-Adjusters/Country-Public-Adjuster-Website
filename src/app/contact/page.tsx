        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          <FadeInView delay={0.1}>
            ...
            >
              ...
              <h2 className="text-xl font-bold text-white mb-3">Start claim intake online</h2>
          ...
          <FadeInView delay={0.2}>
            <div className="card-dark p-7">
              ...
              <h2 className="text-xl font-bold text-white mb-3">Call us directly</h2>
              <p className="text-sm text-white/55 leading-relaxed mb-5">
          ...
          <FadeInView delay={0.3}>
            <div className="card-dark p-7">
              ...
              <h2 className="text-xl font-bold text-white mb-3">After hours?</h2>
              <p className="text-sm text-white/55 leading-relaxed mb-5">
        ...
        <FadeInView delay={0.35}>
          <div className="card-dark p-6 flex flex-col sm:flex-row gap-6 items-start">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-white mb-1">Nashville, Tennessee</div>
                <div className="text-xs text-white/45">Davidson, Williamson, Rutherford, Sumner, Wilson, and surrounding counties</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <MapPin size={18} className="text-gold-500 flex-shrink-0 mt-0.5" />
              <div>
                <div className="text-sm font-bold text-white mb-1">South Florida</div>
                <div className="text-xs text-white/45">Miami-Dade, Broward, and Palm Beach counties</div>
              </div>
            </div>
          </div>
        </FadeInView>
